...
const plans = [
  {
    ...
    price: '49',
    period: '/month',
    description: 'Pay monthly, cancel anytime. Full club access.',
    features: ['Gym, pool & cafe access', 'All group classes', 'Free fitness assessment'],
    cta: 'Start Flex',
    highlighted: false,
  },
  {
  ...
  },
  {
    ...
    features: ['Everything in Commit', 'Unlimited guest passes', 'PT discount 25%', 'Locker, towel & cafe discount'],
    cta: 'Start Elite',
    highlighted: false,
  },
];
